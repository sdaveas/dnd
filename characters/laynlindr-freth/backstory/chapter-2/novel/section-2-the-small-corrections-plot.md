# I.2.2 — The Small Corrections (working title)

### FULL scene/beat specification — v2, consolidated. Not prose.

Alternates for the title: "The Long Quiet", "Nine Years", "The Shaping".
Supersedes the old I.2.2 ("The Plan"); `section-2-the-plan.md` is scraped once this section is written. The keep-list below says what survives. Target length: ~3,000–3,400 words (comparable to I.2.1/I.2.3).
...
3. Establish the sanctioned in-house education of a drow male: basic weapon training, the six inherent powers only (metered), house/city history and law, and Zilvrae's craft of secrecy.
...
7. Keep Zilvrae as the lifelong tutor: strict, fair in her own way, neutral on Layn's path, blind to the psionic gift.
8. Establish why the hearing happens at nineteen: near-adulthood, house law, Melee-Magthere's next opening.
...
- The psionic gift is NOT part of the curriculum. Never named, never trained. The sisters watch for it separately.
...
- **The suppression paradox:** under the fear, the manifestations grow rarer — the sisters' method is working, and the ledger they report upward grows shorter and more cautiously worded each year. But the gift leaks in small, concrete moments (the inventory I.2.3 needs):
  - he knows which servant will drop the tray before it falls;
  - lamps crack above corridors after he passes;
  - he reads where things are hidden without looking.
  Moments. Nothing that held. Nothing repeated on command. (Exact words I.2.3 will reuse.)
...
**Sweeps (between vignettes):** the doorway carving replaced after a servant cracks its leg; two of the older males dying in disputes no one describes as accidents; Dreydre and Greyanna growing stronger — deeper spellcraft, more assured command, the hierarchy never moving; the reports upward growing shorter and more cautiously worded; Zilvrae aging not at all as far as the eye could tell; "He had grown into his silence."; "Useful enough to educate, unimportant enough to ignore."

**Bridge out (to I.2.3):** house law named plainly — a male's path is decided by the Matron Mother when he nears adulthood; Melee-Magthere's next opening is close; the house will hear him in the formal chamber. **The summons = the notice itself:** Greyanna delivers it, and the kept exchange lands — "The hearing is tonight." / "You will answer carefully." / "I always do." / "That is why you are so difficult to improve." — flowing directly into I.2.3's opening. Final image candidates: the spiders' absence that night — for the first time in years, his bed is empty, and he does not sleep anyway.
...
- **TOP RULE: never name "psionic"/"psionics" anywhere in the prose** (the scraped section's "Psionic?" line is the trap; I.2.1 and I.2.3 never name it — use "the pressure," "the thing," "the gift").
- Layn must not: discover or understand his psionic gift; receive psionic training; learn beyond the six sanctioned powers; rebel visibly; stop performing obedience; be told why the spiders come; confront his sisters; learn what the Matron Mother ordered; learn that his sisters report upward; become confident.
- The sisters must not: soften; skip the routine; explain anything; be seen obeying orders; grow careless enough for him to glimpse the full design; rise above the Matron Mother.
- Zilvrae must not: discover the psionic gift; show softness to Layn; take a position on his path; praise him warmly; teach anything that smells like escape.
