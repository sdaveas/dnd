...
- `section-*.md` — comic scripts for individual story sections.
...
`characters/laynlindr-freth/backstory/chapter-1/novel/...`

Defines the actual narrative: scenes, prose, dialogue, events, characterization, and story progression.

### Comic script

`characters/laynlindr-freth/backstory/chapter-1/comic/...`
...
The comic script should not contain the global visual style. It references `characters/laynlindr-freth/backstory/chapter-1/comic/style.md` instead.
